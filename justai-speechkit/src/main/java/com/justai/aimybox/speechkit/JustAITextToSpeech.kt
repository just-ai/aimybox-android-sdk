...
class JustAITextToSpeech(context: Context, private val config: Config, private val okHttpClient: OkHttpClient) : BaseTextToSpeech(context) {

    companion object {
        const val BASE_URL = "https://aimyvoice.com/api/v1/"
    }

    private val ttsService by lazy {
        JASKServiceFactory(BASE_URL, okHttpClient).createService(TTSService::class.java)
    }
